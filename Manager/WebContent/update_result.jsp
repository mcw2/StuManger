<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="com.manager.model.Student"%>
...
<body>
	<jsp:useBean id="student" class="com.manager.model.Student"></jsp:useBean>
	<jsp:useBean id="stuService" class="com.manager.service.StudentService"></jsp:useBean>
